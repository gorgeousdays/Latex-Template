...
\begin{abstract}
    ...
    %总结部分句式参考：In general, although further improvements are needed, the evaluation system constructed by the thesis provides a relatively comprehensive evaluation plan for the spatial and temporal dynamic assessment of ecosystem service value, thus providing a scientific basis for natural asset assessment and ecological compensation.
